...
export const login = async (req, res, next) => {
    ...
    try {
        ...
        next(createError(500, { message: 'Internal Server Error', error: error.message }));
    }
}
...
export const forgotPassword = async (req, res, next) => {
    ...
    try {
        ...
        const resetToken = jwt.sign({ userId: user._id }, process.env.RESET_PASSWORD_SECRET, { expiresIn: '15m' });
...
export const resetPassword = async (req, res, next) => {
    ...
    try {
        const { userId } = jwt.verify(resetToken, process.env.RESET_PASSWORD_SECRET);
